module github.com/chriswoodcn/gocourse
...
require (
	codeup.aliyun.com/6142b6b5ebe08992f3507f10/goRepo/test-private-repo.git v0.0.0-20240111052113-fa4df039ff1d // indirect
